...
public class GetWhenRequestMessage extends Message {
	...
	public boolean equals(Object other) {
		...
		return this.id == that.id && this.key.equals(that.key) && this.keyCond.equals(that.keyCond) 
		&& this.valueCond.equals(that.valueCond);
	}
	...
	public String toString() {
	    ...
	    String res = String.format(str, this.id, this.key, this.keyCond, Arrays.toString(this.valueCond));
	    return res;
	}
